...
class __TwigTemplate_cef4989a15bbeb7e8d351976ed94310dd11c048b746b6d3e3bf6abd59089bd50 extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 38)->display(twig_to_array(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 64)->display(twig_to_array(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 89)->display(twig_to_array(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]));
        // line 90
        echo "
...
//]]></script>
", "@Twig/Exception/exception.html.twig", "C:\\wamp64\\www\\eshop\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\Resources\\views\\Exception\\exception.html.twig");
    }
}
