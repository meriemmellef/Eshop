...
class __TwigTemplate_70710a3df405bf133a9a1de9d4fc9010c080033bcea021bcb5b8581a8e09caac extends \Twig\Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 197
                echo "                ";
                echo $context["__internal_49708377e811cc79e8fb129b5e15d55c491b58ff567b1dc7834b28fa82549d0d"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", []), "forms_by_hash", []));
                echo "
            ";
            }
            $_parent = $context['_parent'];
    ...
    public function getform_tree_entry($__name__ = null, $__data__ = null, $__expanded__ = null, ...$__varargs__)
    {
        ...
        <div class=\"tree-inner\" data-tab-target-id=\"";
            ...
            if (($this->getAttribute(($context["data"] ?? null), "type_class", [], "any", true, true) && $this->getAttribute(($context["data"] ?? null), "type", [], "any", true, true))) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, twig_last($this->env, twig_split_filter($this->env, $this->getAttribute(($context["data"] ?? $this->getContext($context, "data")), "type", []), "\\")), "html", null, true);
                echo "</abbr>]";
            }
            // line 440
            echo "        </div>
