...
class __TwigTemplate_4b71f5d6489246e9bd1e180e57585116871a4014de7e8de8dcba9cc78d0e1d7d extends \Twig\Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 38)->display(twig_to_array(["exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))]));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 64)->display(twig_to_array(["logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", [])]));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 89)->display(twig_to_array(["exception" => ($context["exception"] ?? $this->getContext($context, "exception"))]));
        // line 90
        echo "
