...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.form.something' => 'getApp_Form_SomethingService',
            'app.locale_listener' => 'getApp_LocaleListenerService',
            'app.security.access_denied_handler' => 'getApp_Security_AccessDeniedHandlerService',
            ...
            'custom_user_manager' => 'getCustomUserManagerService',
            ...
            'frontend.form.profile' => 'getFrontend_Form_ProfileService',
            'frontend.form.registration' => 'getFrontend_Form_RegistrationService',
            ...
            'mewes_k_twig_excel.request_listener' => 'getMewesKTwigExcel_RequestListenerService',
            'mewes_k_twig_excel.twig_excel_extension' => 'getMewesKTwigExcel_TwigExcelExtensionService',
            ...
            'skies_barcode.generator' => 'getSkiesBarcode_GeneratorService',
            'skies_barcode.twig.extension' => 'getSkiesBarcode_Twig_ExtensionService',
            ...
            'vich_uploader.namer_uniqid.produits_images' => 'getVichUploader_NamerUniqid_ProduitsImagesService',
            'vich_uploader.namer_uniqid.produits_lib' => 'getVichUploader_NamerUniqid_ProduitsLibService',
        ...
        $this->aliases = array(
            ...
            'fos_user.user_manager' => 'custom_user_manager',
    ...
    /**
     * Gets the public 'app.form.something' shared service.
     *
     * @return \BackendBundle\Form\ProduitType
     */
    protected function getApp_Form_SomethingService()
    {
        return $this->services['app.form.something'] = new \BackendBundle\Form\ProduitType($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'app.locale_listener' shared service.
     *
     * @return \FrontendBundle\EventSubscriber\LocaleSubscriber
     */
    protected function getApp_LocaleListenerService()
    {
        return $this->services['app.locale_listener'] = new \FrontendBundle\EventSubscriber\LocaleSubscriber('fr', 'fr');
    }

    /**
     * Gets the public 'app.security.access_denied_handler' shared service.
     *
     * @return \WebBundle\Security\AccessDeniedHandler
     */
    protected function getApp_Security_AccessDeniedHandlerService()
    {
        return $this->services['app.security.access_denied_handler'] = new \WebBundle\Security\AccessDeniedHandler();
    }

    /**
     * Gets the public 'app.user_locale_listener' shared service.
     *
     * @return \BackendBundle\EventListener\UserLocaleListener
     */
    protected function getApp_UserLocaleListenerService()
    {
        return $this->services['app.user_locale_listener'] = new \BackendBundle\EventListener\UserLocaleListener($this->get('session'), $this->get('request_stack'), $this->get('debug.event_dispatcher'), $this->get('security.token_storage'), $this->get('router'));
    }
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator'), array('width' => 200, 'height' => 50, 'length' => 6, 'font' => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle\\DependencyInjection/../Generator/Font/captcha.ttf'), 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'as_url' => false, 'reload' => false, 'image_folder' => 'captcha', 'web_path' => ($this->targetDirs[2].'/../web'), 'gc_freq' => 100, 'expiration' => 60, 'quality' => 50, 'invalid_message' => 'Bad code value', 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'distortion' => true, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true, 'text_color' => array(), 'background_color' => array(), 'background_images' => array(), 'disabled' => false, 'ignore_all_effects' => false, 'session_key' => 'captcha'));
    }
    ...
    /**
     * Gets the public 'custom_user_manager' shared service.
     *
     * @return \FrontendBundle\Doctrine\CustomUserManager
     */
    protected function getCustomUserManagerService()
    {
        $a = $this->get('fos_user.util.email_canonicalizer');

        return $this->services['custom_user_manager'] = new \FrontendBundle\Doctrine\CustomUserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'WebBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.interactive_login', array(0 => 'app.user_locale_listener', 1 => 'onSecurityInteractiveLogin'), 15);
        ...
        $instance->addListenerService('kernel.request', array(0 => 'mewes_k_twig_excel.request_listener', 1 => 'onKernelRequest'), 0);
        $instance->addSubscriberService('app.locale_listener', 'FrontendBundle\\EventSubscriber\\LocaleSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produits_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produits_lib', $e, $a, $b));
        $f->addEventSubscriber(new \FOS\UserBundle\Entity\UserListener($this));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('produits_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('produits_images', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('produits_lib', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('produits_lib', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('produits_lib', $e, $a, $b));
        $f->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'eshop', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000044f3baf4000000004e710b193edaca162f2e5931253387ac5e62560d(
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\WebBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle\\Entity')));
        ...
        $d->addDriver($b, 'WebBundle\\Entity');
        $d->addDriver($b, 'Vich\\UploaderBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('WebBundle' => 'WebBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity'));
        ...
        $e->addCustomStringFunction('field', 'DoctrineExtensions\\Query\\Mysql\\Field');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d32d98b48bd373668a98ae0246b045fdc823bf0f5135a040a52c597b4b19bac6');
    ...
    {
        $this->services['easyadmin.config.manager'] = $instance = new \EasyCorp\Bundle\EasyAdminBundle\Configuration\ConfigManager($this->get('easyadmin.cache.manager'), $this->get('property_accessor'), array('site_name' => 'Total eCommerce', 'design' => array('brand_color' => '#5594DB', 'menu' => array(0 => array('label' => 'Dashboard', 'route' => 'admin_dashboard', 'default' => true, 'level' => array(0 => 'ROLE_GESTIONNAIRE', 1 => 'ROLE_GROSSISTE')), 1 => array('entity' => 'Produits', 'level' => 'ROLE_GESTIONNAIRE'), 2 => array('entity' => 'Categories', 'label' => 'Gamme', 'level' => 'ROLE_GESTIONNAIRE'), 3 => array('entity' => 'Unite', 'level' => 'ROLE_GESTIONNAIRE'), 4 => array('entity' => 'Grossiste', 'label' => 'Grossiste', 'level' => 'ROLE_GESTIONNAIRE'), 5 => array('entity' => 'Gestionnaire', 'label' => 'Gestionnaire', 'level' => 'ROLE_SUPER_ADMIN'), 6 => array('entity' => 'CommandesGestionnaire', 'label' => 'Commande', 'level' => 'ROLE_GESTIONNAIRE', 'params' => array('sortField' => 'created_at', 'sortDirection' => 'DESC')), 7 => array('entity' => 'CommandesGrossiste', 'level' => 'ROLE_GROSSISTE', 'label' => 'liste Commande')), 'theme' => 'default', 'color_scheme' => 'dark', 'form_theme' => array(0 => '@EasyAdmin/form/bootstrap_3_horizontal_layout.html.twig'), 'assets' => array('css' => array(), 'js' => array(), 'favicon' => array('path' => 'favicon.ico', 'mime_type' => 'image/x-icon'))), 'entities' => array('CommandesGrossiste' => array('disabled_actions' => array(0 => 'new', 1 => 'edit', 2 => 'delete'), 'controller' => 'BackendBundle\\Controller\\Admin\\CommandesController', 'class' => 'WebBundle\\Entity\\Commandes', 'list' => array('max_results' => 10, 'fields' => array(0 => array('property' => 'reference', 'label' => 'Ref#', 'type' => 'string'), 1 => array('property' => 'commande', 'label' => 'Nb Article', 'template' => 'BackendBundle:admin\\commande:nbArticle.html.twig'), 2 => array('property' => 'utilisateur', 'label' => 'Client', 'template' => 'BackendBundle:admin\\commande:nomPrenomClient.html.twig'), 3 => array('property' => 'total', 'label' => 'Totale#', 'template' => 'BackendBundle:admin\\commande:totaleCommande.html.twig'), 4 => array('property' => 'status', 'label' => 'Statut', 'template' => '@Backend/admin/commande/status.html.twig', 'label_colors' => array(0 => 'pending', 1 => 'primary', 2 => 'success', 3 => 'default', 4 => 'danger')), 5 => array('property' => 'dateclient', 'label' => 'Date.Liv Client', 'template' => 'BackendBundle:admin\\commande:dateReservationClient.html.twig'), 6 => array('property' => 'delivery_date', 'label' => 'Date.Liv Grossiste')), 'actions' => array(0 => array('name' => 'show', 'label' => 'voir', 'icon' => 'eye'))), 'name' => 'CommandesGrossiste'), 'Produits' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Produits', 'image_base_path' => '/uploads/produits', 'edit' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'is_active', 5 => 'unite', 6 => 'description', 7 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 8 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'new' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'disponible', 5 => 'is_active', 6 => 'unite', 7 => 'description', 8 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 9 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'form' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'is_active', 5 => 'unite', 6 => 'description', 7 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 8 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'search' => array('fields' => array(0 => 'nom')), 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => array('property' => 'image', 'type' => 'image'), 2 => 'nom', 3 => 'unite', 4 => array('property' => 'uniteDemballage', 'label' => 'UN.EMB'), 5 => array('property' => 'prix', 'format' => '%1.3f'), 6 => array('property' => 'is_active', 'label' => 'Active?'), 7 => 'nb_achat', 8 => array('property' => 'nb_achat', 'label' => 'Nb.CMD.Validé'), 9 => array('property' => 'lib', 'label' => 'Fiche.Tech', 'template' => 'BackendBundle:admin\\produit:ficheTechnique.html.twig'))), 'name' => 'Produits'), 'Categories' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Categories', 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => 'nom'), 'title' => 'Gammes'), 'form' => array('fields' => array(0 => 'nom')), 'search' => array('fields' => array(0 => 'nom')), 'name' => 'Categories'), 'Unite' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Unite', 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => 'libelle')), 'form' => array('fields' => array(0 => 'libelle')), 'search' => array('fields' => array(0 => 'libelle')), 'name' => 'Unite'), 'Grossiste' => array('class' => 'WebBundle\\Entity\\Utilisateurs', 'controller' => 'BackendBundle\\Controller\\Admin\\GrossisteController', 'list' => array('fields' => array(0 => array('property' => 'username_canonical', 'label' => 'Nom d\'utilisateur'), 1 => 'email', 2 => array('property' => 'locked', 'label' => 'Est bloqué ?'), 3 => array('property' => 'last_login', 'label' => 'Date dernière connexion', 'datetime' => 'd/m/Y h:i', 'template' => '@EasyAdmin/default/field_datetime.html.twig')), 'title' => 'La liste des grossites', 'actions' => array(0 => 'new', 1 => 'edit', 2 => array('name' => 'affectation', 'label' => 'Affectation'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'form' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => false)), 5 => 'enabled')), 'new' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => true, 'first_options' => array('label' => 'Mot de passe'), 'second_options' => array('label' => 'Confirmer'), 'type' => 'password', 'invalid_message' => 'Les champs de mot de passe doivent correspondre.')), 5 => 'enabled')), 'edit' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => false, 'first_options' => array('label' => 'Mot de passe'), 'second_options' => array('label' => 'Confirmer'), 'type' => 'password', 'invalid_message' => 'Les champs de mot de passe doivent correspondre.')), 5 => 'enabled'), 'form_options' => array('validation_groups' => array(0 => 'Profile'))), 'name' => 'Grossiste'), 'Gestionnaire' => array('class' => 'WebBundle\\Entity\\Utilisateurs', 'controller' => 'BackendBundle\\Controller\\Admin\\GestionnaireController', 'list' => array('fields' => array(0 => array('property' => 'username_canonical', 'label' => 'Nom d\'utilisateur'), 1 => 'email', 2 => array('property' => 'locked', 'label' => 'Est bloqué ?'), 3 => array('property' => 'last_login', 'label' => 'Date dernière connexion', 'format' => 'd/m/Y h:i', 'template' => '@EasyAdmin/default/field_datetime.html.twig')), 'title' => 'La liste des gestionnaires', 'actions' => array(0 => 'new', 1 => 'edit')), 'form' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => 'enabled')), 'name' => 'Gestionnaire'), 'CommandesGestionnaire' => array('class' => 'WebBundle\\Entity\\Commandes', 'controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'disabled_actions' => array(0 => 'delete', 1 => 'edit', 2 => 'new'), 'list' => array('fields' => array(0 => array('property' => 'reference', 'label' => 'Ref CMD', 'type' => 'string'), 1 => array('property' => 'commande', 'label' => 'Nb Article', 'template' => 'BackendBundle:admin\\commande:nbArticle.html.twig'), 2 => array('property' => 'utilisateur', 'label' => 'Client', 'template' => 'BackendBundle:admin\\commande:nomPrenomClient.html.twig'), 3 => array('property' => 'total', 'label' => 'Total Commande', 'template' => 'BackendBundle:admin\\commande:totaleCommande.html.twig'), 4 => array('property' => 'status', 'label' => 'Statut', 'template' => '@Backend/admin/commande/status.html.twig', 'label_colors' => array(0 => 'pending', 1 => 'primary', 2 => 'success', 3 => 'default', 4 => 'danger')), 5 => array('property' => 'grossiste', 'label' => 'Grossiste', 'template' => 'BackendBundle:admin\\commande:grossisteCommande.html.twig'), 6 => array('property' => 'dateclient', 'label' => 'Date.Liv.Client', 'template' => 'BackendBundle:admin\\commande:dateReservationClient.html.twig'), 7 => array('property' => 'delivery_date', 'label' => 'Date.Liv.Grossiste')), 'actions' => array(0 => array('name' => 'show', 'label' => 'voir', 'icon' => 'eye'), 1 => array('name' => 'affecter', 'label' => 'Affecter.Auto', 'icon' => 'pencil'))), 'name' => 'CommandesGestionnaire')), 'formats' => array('date' => 'Y-m-d', 'time' => 'H:i:s', 'datetime' => 'F j, Y H:i', 'dateinterval' => '%y Year(s) %m Month(s) %d Day(s)'), 'disabled_actions' => array(), 'translation_domain' => 'messages', 'list' => array('actions' => array(), 'max_results' => 15), 'search' => array(), 'edit' => array('actions' => array()), 'new' => array('actions' => array()), 'show' => array('actions' => array(), 'max_results' => 10)), true);
    ...
    protected function getFosUser_ChangePassword_Form_Handler_DefaultService()
    {
        ...
        return $this->services['fos_user.change_password.form.handler.default'] = $this->scopedServices['request']['fos_user.change_password.form.handler.default'] = new \FOS\UserBundle\Form\Handler\ChangePasswordFormHandler($this->get('fos_user.change_password.form'), $this->get('request'), $this->get('custom_user_manager'));
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('pumpattendee@gmail.com' => 'pumpattendee@gmail.com'), 'resetting' => array('pumpattendee@gmail.com' => 'pumpattendee@gmail.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'FrontendBundle\\Form\\EditProfileType', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    protected function getFosUser_Profile_Form_HandlerService()
    {
        ...
        return $this->services['fos_user.profile.form.handler'] = $this->scopedServices['request']['fos_user.profile.form.handler'] = new \FOS\UserBundle\Form\Handler\ProfileFormHandler($this->get('fos_user.profile.form'), $this->get('request'), $this->get('custom_user_manager'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('WebBundle\\Entity\\Utilisateurs');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'FrontendBundle\\Form\\RegistrationType', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    protected function getFosUser_Registration_Form_HandlerService()
    {
        ...
        return $this->services['fos_user.registration.form.handler'] = $this->scopedServices['request']['fos_user.registration.form.handler'] = new \FOS\UserBundle\Form\Handler\RegistrationFormHandler($this->get('fos_user.registration.form'), $this->get('request'), $this->get('custom_user_manager'), $this->get('fos_user.mailer'), $this->get('fos_user.util.token_generator'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('WebBundle\\Entity\\Utilisateurs');
    }
    ...
    protected function getFosUser_Resetting_Form_HandlerService()
    {
        ...
        return $this->services['fos_user.resetting.form.handler'] = $this->scopedServices['request']['fos_user.resetting.form.handler'] = new \FOS\UserBundle\Form\Handler\ResettingFormHandler($this->get('fos_user.resetting.form'), $this->get('request'), $this->get('custom_user_manager'));
    }
    ...
    {
        return $this->services['fos_user.security.interactive_login_listener'] = new \FOS\UserBundle\Security\InteractiveLoginListener($this->get('custom_user_manager'));
    }
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.context'), $this->get('security.user_checker.admin'), $this->get('security.authentication.session_strategy.admin'), $this);
    }
    ...
    {
        return $this->services['fos_user.username_form_type'] = new \FOS\UserBundle\Form\Type\UsernameFormType(new \FOS\UserBundle\Form\DataTransformer\UserToUsernameTransformer($this->get('custom_user_manager')));
    }
    ...
    {
        return $this->services['fos_user.util.user_manipulator'] = new \FOS\UserBundle\Util\UserManipulator($this->get('custom_user_manager'));
    }
    ...
    /**
     * Gets the public 'frontend.form.profile' shared service.
     *
     * @return \FrontendBundle\Form\EditProfileType
     */
    protected function getFrontend_Form_ProfileService()
    {
        return $this->services['frontend.form.profile'] = new \FrontendBundle\Form\EditProfileType();
    }

    /**
     * Gets the public 'frontend.form.registration' shared service.
     *
     * @return \FrontendBundle\Form\RegistrationType
     */
    protected function getFrontend_Form_RegistrationService()
    {
        return $this->services['frontend.form.registration'] = new \FrontendBundle\Form\RegistrationType();
    }
    ...
    public function getKnpPaginatorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['knp_paginator'] = new KnpComponentPagerPaginator_0000000044f3a376000000004e710b193edaca162f2e5931253387ac5e62560d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
                    $wrappedInstance = $container->getKnpPaginatorService(false);
        ...
        $instance = new \Knp\Component\Pager\Paginator($this->get('debug.event_dispatcher'));
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'BackendBundle:paginator:paginator.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => '@KnpPaginator/Pagination/filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    /**
     * Gets the public 'mewes_k_twig_excel.request_listener' shared service.
     *
     * @return \MewesK\TwigExcelBundle\EventListener\RequestListener
     */
    protected function getMewesKTwigExcel_RequestListenerService()
    {
        return $this->services['mewes_k_twig_excel.request_listener'] = new \MewesK\TwigExcelBundle\EventListener\RequestListener();
    }

    /**
     * Gets the public 'mewes_k_twig_excel.twig_excel_extension' shared service.
     *
     * @return \MewesK\TwigExcelBundle\Twig\TwigExcelExtension
     */
    protected function getMewesKTwigExcel_TwigExcelExtensionService()
    {
        return $this->services['mewes_k_twig_excel.twig_excel_extension'] = new \MewesK\TwigExcelBundle\Twig\TwigExcelExtension(true, NULL);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.admin' => new \Symfony\Component\HttpFoundation\RequestMatcher('/log_back_end/(.*)'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $g->setOptions(array('login_path' => 'admin_login', 'default_target_path' => '/log_back_end/dashboard', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'admin_login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'admin_logout'));
        $i->addHandler($this->get('security.logout.handler.csrf_token_clearing'));
        $i->addHandler($this->get('security.logout.handler.session'));

        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'application', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy.admin'), $d, 'admin', $g, $h, array('check_path' => 'admin_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '64dfeddea1e463.29922236', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'admin_login', false), NULL, $this->get('app.security.access_denied_handler'), $b, false), $i);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array());
        $g->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => '/', 'use_referer' => false, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'));
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $i->addHandler($this->get('security.logout.handler.csrf_token_clearing'));
        $i->addHandler($this->get('security.logout.handler.session'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy.admin'), $d, 'main', $g, $h, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '64dfeddea1e463.29922236', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'fos_user_security_login', false), NULL, $this->get('app.security.access_denied_handler'), $b, false), $i);
    }
     ...
     *
     * @return \FrontendBundle\Services\GetFacture
     */
    protected function getSetnewfactureService()
    {
        return $this->services['setnewfacture'] = new \FrontendBundle\Services\GetFacture($this);
    }

    /**
     * Gets the public 'setnewreference' shared service.
     *
     * @return \FrontendBundle\Services\GetReference
     */
    protected function getSetnewreferenceService()
    {
        return $this->services['setnewreference'] = new \FrontendBundle\Services\GetReference($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'skies_barcode.generator' shared service.
     *
     * @return \Skies\QRcodeBundle\Generator\Generator
     */
    protected function getSkiesBarcode_GeneratorService()
    {
        return $this->services['skies_barcode.generator'] = new \Skies\QRcodeBundle\Generator\Generator();
    }

    /**
     * Gets the public 'skies_barcode.twig.extension' shared service.
     *
     * @return \Skies\QRcodeBundle\Twig\Extensions\Barcode
     */
    protected function getSkiesBarcode_Twig_ExtensionService()
    {
        return $this->services['skies_barcode.twig.extension'] = new \Skies\QRcodeBundle\Twig\Extensions\Barcode($this->get('skies_barcode.generator'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ar.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ar.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ar.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.ar.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ar.yml'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.ar.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.ar.yml')), 'az' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.az.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.az.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.az.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.bg.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.bg.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.bg.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.bg.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.bg.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.bg.yml')), 'ca' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ca.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ca.yml'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ca.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.ca.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.cs.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.cs.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.cs.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.cs.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.cs.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.cs.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.cs.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.cs.yml')), 'cy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.da.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.da.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.da.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.da.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.da.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.da.xlf')), 'de' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.de.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.de.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.de.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.de.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.de.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.de.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.de.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.de.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.de.yml')), 'el' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.el.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.el.xlf'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.el.xlf')), 'en' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.en.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.en.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.en.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.en.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.en.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.en.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.en.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.en.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.en.yml'), 11 => ($this->targetDirs[2].'/Resources/translations\\FOSUserBundle.en.yml'), 12 => ($this->targetDirs[2].'/Resources/translations\\messages.en.yml'), 13 => ($this->targetDirs[2].'/Resources/translations\\validators.en.yml')), 'es' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.es.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.es.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.es.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.es.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.es.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.es.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.es.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.es.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.es.yml')), 'et' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.et.yml')), 'eu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.eu.yml'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.eu.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.eu.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fa.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.fa.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fa.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fa.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fa.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.fa.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fi.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fi.yml'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fi.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.fi.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.fr.xlf'), 3 => ($this->targetDirs[3].'\\src\\FrontendBundle/Resources/translations\\FOSUserBundle.fr.yml'), 4 => ($this->targetDirs[3].'\\src\\FrontendBundle/Resources/translations\\validators.fr.yml'), 5 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.fr.xliff'), 6 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml'), 7 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fr.yml'), 8 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.fr.xlf'), 9 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.fr.xlf'), 10 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.fr.yml'), 11 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.fr.yml'), 12 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.fr.yml'), 13 => ($this->targetDirs[2].'/Resources/translations\\FOSUserBundle.fr.yml'), 14 => ($this->targetDirs[2].'/Resources/translations\\messages.fr.yml'), 15 => ($this->targetDirs[2].'/Resources/translations\\validators.fr.yml')), 'gl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.gl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.gl.xlf'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.gl.xlf')), 'he' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.he.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hr.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hr.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hr.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.hr.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.hu.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.hu.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hu.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hu.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.hu.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.hu.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.hu.yml')), 'hy' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf')), 'id' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.id.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.id.xliff')), 'it' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.it.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.it.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.it.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.it.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.it.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.it.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.it.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.it.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.it.yml')), 'ja' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ja.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ja.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ja.yml')), 'lb' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lb.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lb.yml')), 'lt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lt.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.lt.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lt.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lt.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.lt.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.lt.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.lv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lv.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lv.yml')), 'mn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nb.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.nl.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nl.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.nl.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.nl.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.nl.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.nl.yml')), 'nn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nn.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.nn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.no.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.no.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.pl.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pl.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pl.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pl.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.pl.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pl.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.pl.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.pl.yml')), 'pt' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt.yml'), 3 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.pt.xlf'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.pt.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.pt.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.pt_BR.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_BR.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt_BR.yml'), 6 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.pt_BR.yml'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.pt_BR.yml')), 'ro' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ro.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ro.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ro.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ro.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.ro.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.ro.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.ro.yml')), 'ru' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ru.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ru.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ru.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ru.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.ru.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.ru.xlf'), 8 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.ru.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.ru.yml'), 10 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.ru.yml')), 'sk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sk.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sk.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sk.yml')), 'sl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sl.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sl.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sl.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sl.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.sl.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.sl.yml')), 'sq' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Cyrl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sr_Latn.yml')), 'sv' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.sv.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.sv.xliff'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sv.yml'), 5 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sv.yml'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sv.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.sv.xlf')), 'th' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.th.xlf')), 'tl' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tl.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.tl.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tl.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.tr.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.tr.yml'), 4 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.tr.xlf'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.tr.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.tr.yml'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.tr.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.tr.yml')), 'uk' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.uk.xliff'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.uk.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.uk.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.uk.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.uk.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/translations\\VichUploaderBundle.uk.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.uk.yml'), 9 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.uk.yml')), 'vi' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.vi.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.zh_CN.yml'), 4 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.zh_CN.yml'), 5 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.zh_CN.xlf'), 6 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.zh_CN.xlf'), 7 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.zh_CN.yml'), 8 => ($this->targetDirs[3].'\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.zh_CN.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.pt_PT.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_PT.yml')), 'ua' => array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core/Resources/translations\\security.ua.xlf')), 'ky' => array(0 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.ky.xliff')), 'sw' => array(0 => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/translations\\KnpPaginatorBundle.sw.xliff')), 'sr_RS' => array(0 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\EasyAdminBundle.sr_RS.xlf'), 1 => ($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle\\src/Resources/translations\\messages.sr_RS.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \FrontendBundle\Twig\AppExtension());
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => '@GregwarCaptcha/captcha.html.twig', 1 => '@VichUploader/Form/fields.html.twig', 2 => 'form_div_layout.html.twig', 3 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        ...
        $instance->addExtension($this->get('mewes_k_twig_excel.twig_excel_extension'));
        $instance->addExtension($this->get('skies_barcode.twig.extension'));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension($this->get('var_dumper.cloner')));
        $instance->addExtension(new \Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension());
        $instance->addGlobal('app', $g);
        $instance->addGlobal('img_path', '/uploads/produits');
        $instance->addGlobal('condition_vente_directory', '/uploads/condition_vente');
        $instance->addGlobal('condition_general_directory', '/uploads/condtion_general');
        $instance->addGlobal('personal_data_directory', '/uploads/personal_data');
        $instance->addGlobal('legal_notice_directory', '/uploads/legal_notice');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\FrontendBundle/Resources/views'), 'FOSUser');
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/EasyAdminBundle/views'), 'EasyAdmin');
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/GregwarCaptchaBundle/views'), 'GregwarCaptcha');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addObjectInitializers(array(0 => $this->get('doctrine.orm.validator_initializer'), 1 => new \FOS\UserBundle\Validator\Initializer($this->get('custom_user_manager'))));
    ...
    {
        return $this->services['vich_uploader.form.type.image'] = new \Vich\UploaderBundle\Form\Type\VichImageType($this->get('vich_uploader.storage'), $this->get('vich_uploader.upload_handler'), $this->get('vich_uploader.property_mapping_factory'), $this->get('property_accessor'), $this->get('liip_imagine.cache.manager', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['vich_uploader.namer_directory_property'] = new \Vich\UploaderBundle\Naming\PropertyDirectoryNamer($this->get('property_accessor'));
    }
    ...
    /**
     * Gets the public 'vich_uploader.namer_uniqid.produits_images' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_ProduitsImagesService()
    {
        return $this->services['vich_uploader.namer_uniqid.produits_images'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }

    /**
     * Gets the public 'vich_uploader.namer_uniqid.produits_lib' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_ProduitsLibService()
    {
        return $this->services['vich_uploader.namer_uniqid.produits_lib'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    {
        return $this->services['fos_user.user_provider.username_email'] = new \FOS\UserBundle\Security\EmailUserProvider($this->get('custom_user_manager'));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/commandes'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/produit'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/livraison'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('/profile.*'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/logout$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/login_check$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/pays/'), array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/user/'), array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/produit/get_sous_categorie_from_categorie'), array(0 => 'ROLE_GESTIONNAIRE', 1 => 'ROLE_GERANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/dashboard/'), array(0 => 'ROLE_GESTIONNAIRE', 1 => 'ROLE_SUPER_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/station/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/gerant/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/categorie/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/sous_categorie/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/commande/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/client/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/produit/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/coupon/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/parametre/'), array(0 => 'ROLE_GESTIONNAIRE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/dashboard_gerant/'), array(0 => 'ROLE_GERANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/produitgerant/'), array(0 => 'ROLE_GERANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/commandegerant/'), array(0 => 'ROLE_GERANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/horaire_gerant/'), array(0 => 'ROLE_GERANT'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/log_back_end/'), array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_GESTIONNAIRE', 2 => 'ROLE_GERANT'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('64dfeddea1e463.29922236'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('64dfeddea1e463.29922236')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_FRONTEND' => array(0 => 'ROLE_CLIENT'), 'ROLE_BACKEND' => array(0 => 'ROLE_CLIENT', 1 => 'ROLE_GERANT', 2 => 'ROLE_GESTIONNAIRE', 3 => 'ROLE_SUPER_ADMIN')));
    }
    ...
    protected function getVichUploader_MetadataReaderService()
    {
        ...
        $b = new \Metadata\MetadataFactory(new \Metadata\Driver\DriverChain(array(0 => new \Vich\UploaderBundle\Metadata\Driver\AnnotationDriver($this->get('annotation_reader')), 1 => new \Vich\UploaderBundle\Metadata\Driver\YamlDriver($a), 2 => new \Vich\UploaderBundle\Metadata\Driver\XmlDriver($a))), 'Metadata\\ClassHierarchyMetadata', true);
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('produits_images' => array('namer' => array('service' => 'vich_uploader.namer_uniqid.produits_images', 'options' => array()), 'uri_prefix' => '/uploads/produits', 'upload_destination' => ($this->targetDirs[2].'/../web/uploads/produits'), 'directory_namer' => array('service' => NULL, 'options' => NULL), 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm'), 'produits_lib' => array('namer' => array('service' => 'vich_uploader.namer_uniqid.produits_lib', 'options' => array()), 'uri_prefix' => '/uploads/produits/fiche_technique', 'upload_destination' => ($this->targetDirs[2].'/../web/uploads/produits/fiche_technique'), 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => true, 'directory_namer' => array('service' => NULL, 'options' => NULL), 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MewesKTwigExcelBundle' => 'MewesK\\TwigExcelBundle\\MewesKTwigExcelBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'FrontendBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\FrontendBundle'),
                ...
                'MewesKTwigExcelBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\mewesk\\twig-excel-bundle'),
                    'namespace' => 'MewesK\\TwigExcelBundle',
                ),
                'SkiesQRcodeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\yellowskies\\qr-code-bundle'),
            ...
            'locale' => 'fr',
            'app_locales' => 'fr|en',
            'image_directory' => ($this->targetDirs[2].'/../web/uploads/produits'),
            'condition_vente_directory' => ($this->targetDirs[2].'/../web/uploads/condition_vente'),
            'condition_general_directory' => ($this->targetDirs[2].'/../web/uploads/condtion_general'),
            'personal_data_directory' => ($this->targetDirs[2].'/../web/uploads/personal_data'),
            'legal_notice_directory' => ($this->targetDirs[2].'/../web/uploads/legal_notice'),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'pumpattendee@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'incentive123',
            ...
            'knp_paginator.template.pagination' => 'BackendBundle:paginator:paginator.html.twig',
            ...
            'fos_user.model.user.class' => 'WebBundle\\Entity\\Utilisateurs',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'FrontendBundle\\Form\\EditProfileType',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'pumpattendee@gmail.com' => 'pumpattendee@gmail.com',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'FrontendBundle\\Form\\RegistrationType',
            ...
            'fos_user.resetting.token_ttl' => 100,
                ...
                'design' => array(
                    ...
                    'menu' => array(
                        ...
                        5 => array(
                            'entity' => 'Gestionnaire',
                            'label' => 'Gestionnaire',
                            'level' => 'ROLE_SUPER_ADMIN',
                        ),
                        6 => array(
                            'entity' => 'CommandesGestionnaire',
                            'label' => 'Commande',
                            'level' => 'ROLE_GESTIONNAIRE',
                            'params' => array(
                        ...
                        7 => array(
                            'entity' => 'CommandesGrossiste',
                            'level' => 'ROLE_GROSSISTE',
                        ...
                        'list' => array(
                            ...
                            'fields' => array(
                                ...
                                1 => array(
                                    'property' => 'commande',
                                    'label' => 'Nb Article',
                                    'template' => 'BackendBundle:admin\\commande:nbArticle.html.twig',
                                ),
                                2 => array(
                                    'property' => 'utilisateur',
                                    'label' => 'Client',
                                    'template' => 'BackendBundle:admin\\commande:nomPrenomClient.html.twig',
                                ),
                                3 => array(
                                    'property' => 'total',
                                    'label' => 'Totale#',
                                    'template' => 'BackendBundle:admin\\commande:totaleCommande.html.twig',
                                ),
                                4 => array(
                                    'property' => 'status',
                                    'label' => 'Statut',
                                    'template' => '@Backend/admin/commande/status.html.twig',
                                    'label_colors' => array(
                                        0 => 'pending',
                                        1 => 'primary',
                                        2 => 'success',
                                ...
                                5 => array(
                                    'property' => 'dateclient',
                                    'label' => 'Date.Liv Client',
                                    'template' => 'BackendBundle:admin\\commande:dateReservationClient.html.twig',
                                ),
                                6 => array(
                                    'property' => 'delivery_date',
                                    'label' => 'Date.Liv Grossiste',
                                ),
                            ),
                            'actions' => array(
                                0 => array(
                    ...
                    'Produits' => array(
                        ...
                        'edit' => array(
                            'fields' => array(
                                ...
                                2 => 'prix',
                                3 => array(
                                    'property' => 'uniteDemballage',
                                    'label' => 'Unité d\'embalage',
                                ),
                                4 => 'is_active',
                                5 => 'unite',
                                6 => 'description',
                        ...
                        'list' => array(
                            ...
                            'fields' => array(
                                ...
                                9 => array(
                                    'property' => 'lib',
                                    'label' => 'Fiche.Tech',
                                    'template' => 'BackendBundle:admin\\produit:ficheTechnique.html.twig',
                                ),
                            ),
                        ),
                        'name' => 'Produits',
                        ...
                        'list' => array(
                            'fields' => array(
                                ...
                                5 => array(
                                    'property' => 'grossiste',
                                    'label' => 'Grossiste',
                                    'template' => 'BackendBundle:admin\\commande:grossisteCommande.html.twig',
                                ),
                                6 => array(
                                    'property' => 'dateclient',
                                    'label' => 'Date.Liv.Client',
            ...
            'vich_uploader.mappings' => array(
                'produits_images' => array(
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.produits_images',
                        'options' => array(

                        ),
                    ),
                    'uri_prefix' => '/uploads/produits',
                    'upload_destination' => ($this->targetDirs[2].'/../web/uploads/produits'),
                ...
                'produits_lib' => array(
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.produits_lib',
                        'options' => array(
            ...
            'mewes_k_twig_excel.request_listener.class' => 'MewesK\\TwigExcelBundle\\EventListener\\RequestListener',
            'mewes_k_twig_excel.twig_excel_extension.class' => 'MewesK\\TwigExcelBundle\\Twig\\TwigExcelExtension',
            'mewes_k_twig_excel.pre_calculate_formulas' => true,
            'mewes_k_twig_excel.disk_caching_directory' => NULL,
            'doctrine_migrations.dir_name' => ($this->targetDirs[2].'/../src/WebBundle/DoctrineMigrations'),
            'doctrine_migrations.namespace' => 'WebBundle\\DoctrineMigrations',
...
class DoctrineORMEntityManager_0000000044f3baf4000000004e710b193edaca162f2e5931253387ac5e62560d extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder64dfede0ac6ef934693063 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer64dfede0ac702933795259 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties64dfede0ac6c8159942142 = array(
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getConnection', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getConnection();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getMetadataFactory', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getMetadataFactory();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getExpressionBuilder', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getExpressionBuilder();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'beginTransaction', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->beginTransaction();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getCache', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getCache();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'transactional', array('func' => $func), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->transactional($func);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'commit', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->commit();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'rollback', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->rollback();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getClassMetadata', array('className' => $className), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getClassMetadata($className);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'createQuery', array('dql' => $dql), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->createQuery($dql);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'createNamedQuery', array('name' => $name), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->createNamedQuery($name);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'createQueryBuilder', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->createQueryBuilder();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'flush', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->flush($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'clear', array('entityName' => $entityName), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->clear($entityName);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'close', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->close();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'persist', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->persist($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'remove', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->remove($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'refresh', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->refresh($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'detach', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->detach($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'merge', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->merge($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->copy($entity, $deep);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getRepository', array('entityName' => $entityName), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getRepository($entityName);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'contains', array('entity' => $entity), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->contains($entity);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getEventManager', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getEventManager();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getConfiguration', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getConfiguration();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'isOpen', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->isOpen();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getUnitOfWork', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getUnitOfWork();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getProxyFactory', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getProxyFactory();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'initializeObject', array('obj' => $obj), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->initializeObject($obj);
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'getFilters', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->getFilters();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'isFiltersStateClean', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->isFiltersStateClean();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'hasFilters', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return $this->valueHolder64dfede0ac6ef934693063->hasFilters();
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 = $initializer;
    }
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__get', array('name' => $name), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        if (isset(self::$publicProperties64dfede0ac6c8159942142[$name])) {
            return $this->valueHolder64dfede0ac6ef934693063->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfede0ac6ef934693063;
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__isset', array('name' => $name), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__unset', array('name' => $name), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;
    ...
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__clone', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        $this->valueHolder64dfede0ac6ef934693063 = clone $this->valueHolder64dfede0ac6ef934693063;
    }

    public function __sleep()
    {
        $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, '__sleep', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;

        return array('valueHolder64dfede0ac6ef934693063');
    }
    ...
    {
        return $this->initializer64dfede0ac702933795259;
    }
    ...
    {
        return $this->initializer64dfede0ac702933795259 && ($this->initializer64dfede0ac702933795259->__invoke($valueHolder64dfede0ac6ef934693063, $this, 'initializeProxy', array(), $this->initializer64dfede0ac702933795259) || 1) && $this->valueHolder64dfede0ac6ef934693063 = $valueHolder64dfede0ac6ef934693063;
    }
    ...
    {
        return null !== $this->valueHolder64dfede0ac6ef934693063;
    }
    ...
    {
        return $this->valueHolder64dfede0ac6ef934693063;
    }


}

class KnpComponentPagerPaginator_0000000044f3a376000000004e710b193edaca162f2e5931253387ac5e62560d extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder64dfede0bcb55135177796 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer64dfede0bcb7f461129032 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties64dfede0bcb37967522583 = array(
    ...
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        return $this->valueHolder64dfede0bcb55135177796->setDefaultPaginatorOptions($options);
    }
    ...
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        return $this->valueHolder64dfede0bcb55135177796->paginate($target, $page, $limit, $options);
    }
    ...
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        return $this->valueHolder64dfede0bcb55135177796->subscribe($subscriber);
    }
    ...
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        return $this->valueHolder64dfede0bcb55135177796->connect($eventName, $listener, $priority);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer64dfede0bcb7f461129032 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__get', array('name' => $name), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        if (isset(self::$publicProperties64dfede0bcb37967522583[$name])) {
            return $this->valueHolder64dfede0bcb55135177796->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfede0bcb55135177796;
    ...
    public function __set($name, $value)
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;
    ...
    public function __isset($name)
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__isset', array('name' => $name), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;
    ...
    public function __unset($name)
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__unset', array('name' => $name), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;
    ...
    public function __clone()
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__clone', array(), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        $this->valueHolder64dfede0bcb55135177796 = clone $this->valueHolder64dfede0bcb55135177796;
    }

    public function __sleep()
    {
        $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, '__sleep', array(), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;

        return array('valueHolder64dfede0bcb55135177796');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer64dfede0bcb7f461129032;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer64dfede0bcb7f461129032 && ($this->initializer64dfede0bcb7f461129032->__invoke($valueHolder64dfede0bcb55135177796, $this, 'initializeProxy', array(), $this->initializer64dfede0bcb7f461129032) || 1) && $this->valueHolder64dfede0bcb55135177796 = $valueHolder64dfede0bcb55135177796;
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder64dfede0bcb55135177796;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder64dfede0bcb55135177796;
    }
