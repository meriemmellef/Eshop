...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['app.user_locale_listener'] = new \BackendBundle\EventListener\UserLocaleListener($this->get('session'), $this->get('request_stack'), $this->get('event_dispatcher'), $this->get('security.token_storage'), $this->get('router'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produits_images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produits_lib', $c, $a, $b));
        $d->addEventSubscriber(new \FOS\UserBundle\Entity\UserListener($this));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('produits_images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('produits_images', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('produits_lib', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('produits_lib', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('produits_lib', $c, $a, $b));
        $d->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'eshop', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_00000000558622e900000000270ffb928e39438d2e9766a43e958a5652d9de6f(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7c2bf0ff5b264805897b069d6e097dc3e55f541317ff3d38b1d299a8398a5ded');
    ...
    {
        return $this->services['easyadmin.listener.exception'] = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\ExceptionListener($this->get('twig'), array('site_name' => 'Total eCommerce', 'design' => array('brand_color' => '#5594DB', 'menu' => array(0 => array('label' => 'Dashboard', 'route' => 'admin_dashboard', 'default' => true, 'level' => array(0 => 'ROLE_GESTIONNAIRE', 1 => 'ROLE_GROSSISTE')), 1 => array('entity' => 'Produits', 'level' => 'ROLE_GESTIONNAIRE'), 2 => array('entity' => 'Categories', 'label' => 'Gamme', 'level' => 'ROLE_GESTIONNAIRE'), 3 => array('entity' => 'Unite', 'level' => 'ROLE_GESTIONNAIRE'), 4 => array('entity' => 'Grossiste', 'label' => 'Grossiste', 'level' => 'ROLE_GESTIONNAIRE'), 5 => array('entity' => 'Gestionnaire', 'label' => 'Gestionnaire', 'level' => 'ROLE_SUPER_ADMIN'), 6 => array('entity' => 'CommandesGestionnaire', 'label' => 'Commande', 'level' => 'ROLE_GESTIONNAIRE', 'params' => array('sortField' => 'created_at', 'sortDirection' => 'DESC')), 7 => array('entity' => 'CommandesGrossiste', 'level' => 'ROLE_GROSSISTE', 'label' => 'liste Commande')), 'theme' => 'default', 'color_scheme' => 'dark', 'form_theme' => array(0 => '@EasyAdmin/form/bootstrap_3_horizontal_layout.html.twig'), 'assets' => array('css' => array(), 'js' => array(), 'favicon' => array('path' => 'favicon.ico', 'mime_type' => 'image/x-icon'))), 'entities' => array('CommandesGrossiste' => array('disabled_actions' => array(0 => 'new', 1 => 'edit', 2 => 'delete'), 'controller' => 'BackendBundle\\Controller\\Admin\\CommandesController', 'class' => 'WebBundle\\Entity\\Commandes', 'list' => array('max_results' => 10, 'fields' => array(0 => array('property' => 'reference', 'label' => 'Ref#', 'type' => 'string'), 1 => array('property' => 'commande', 'label' => 'Nb Article', 'template' => 'BackendBundle:admin\\commande:nbArticle.html.twig'), 2 => array('property' => 'utilisateur', 'label' => 'Client', 'template' => 'BackendBundle:admin\\commande:nomPrenomClient.html.twig'), 3 => array('property' => 'total', 'label' => 'Totale#', 'template' => 'BackendBundle:admin\\commande:totaleCommande.html.twig'), 4 => array('property' => 'status', 'label' => 'Statut', 'template' => '@Backend/admin/commande/status.html.twig', 'label_colors' => array(0 => 'pending', 1 => 'primary', 2 => 'success', 3 => 'default', 4 => 'danger')), 5 => array('property' => 'dateclient', 'label' => 'Date.Liv Client', 'template' => 'BackendBundle:admin\\commande:dateReservationClient.html.twig'), 6 => array('property' => 'delivery_date', 'label' => 'Date.Liv Grossiste')), 'actions' => array(0 => array('name' => 'show', 'label' => 'voir', 'icon' => 'eye'))), 'name' => 'CommandesGrossiste'), 'Produits' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Produits', 'image_base_path' => '/uploads/produits', 'edit' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'is_active', 5 => 'unite', 6 => 'description', 7 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 8 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'new' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'disponible', 5 => 'is_active', 6 => 'unite', 7 => 'description', 8 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 9 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'form' => array('fields' => array(0 => 'nom', 1 => array('property' => 'categorie', 'type' => 'entity', 'type_options' => array('class' => 'WebBundle\\Entity\\Categories', 'choice_label' => 'getNom')), 2 => 'prix', 3 => array('property' => 'uniteDemballage', 'label' => 'Unité d\'embalage'), 4 => 'is_active', 5 => 'unite', 6 => 'description', 7 => array('property' => 'imageFile', 'type' => 'vich_image', 'type_options' => array('required' => false, 'allow_delete' => false)), 8 => array('property' => 'file', 'type' => 'vich_file', 'label' => 'Fiche technique', 'type_options' => array('required' => false, 'allow_delete' => false)))), 'search' => array('fields' => array(0 => 'nom')), 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => array('property' => 'image', 'type' => 'image'), 2 => 'nom', 3 => 'unite', 4 => array('property' => 'uniteDemballage', 'label' => 'UN.EMB'), 5 => array('property' => 'prix', 'format' => '%1.3f'), 6 => array('property' => 'is_active', 'label' => 'Active?'), 7 => 'nb_achat', 8 => array('property' => 'nb_achat', 'label' => 'Nb.CMD.Validé'), 9 => array('property' => 'lib', 'label' => 'Fiche.Tech', 'template' => 'BackendBundle:admin\\produit:ficheTechnique.html.twig'))), 'name' => 'Produits'), 'Categories' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Categories', 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => 'nom'), 'title' => 'Gammes'), 'form' => array('fields' => array(0 => 'nom')), 'search' => array('fields' => array(0 => 'nom')), 'name' => 'Categories'), 'Unite' => array('controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'class' => 'WebBundle\\Entity\\Unite', 'list' => array('max_results' => 10, 'fields' => array(0 => 'id', 1 => 'libelle')), 'form' => array('fields' => array(0 => 'libelle')), 'search' => array('fields' => array(0 => 'libelle')), 'name' => 'Unite'), 'Grossiste' => array('class' => 'WebBundle\\Entity\\Utilisateurs', 'controller' => 'BackendBundle\\Controller\\Admin\\GrossisteController', 'list' => array('fields' => array(0 => array('property' => 'username_canonical', 'label' => 'Nom d\'utilisateur'), 1 => 'email', 2 => array('property' => 'locked', 'label' => 'Est bloqué ?'), 3 => array('property' => 'last_login', 'label' => 'Date dernière connexion', 'datetime' => 'd/m/Y h:i', 'template' => '@EasyAdmin/default/field_datetime.html.twig')), 'title' => 'La liste des grossites', 'actions' => array(0 => 'new', 1 => 'edit', 2 => array('name' => 'affectation', 'label' => 'Affectation'), 3 => array('name' => 'delete', 'label' => 'Supprimer'))), 'form' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => false)), 5 => 'enabled')), 'new' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => true, 'first_options' => array('label' => 'Mot de passe'), 'second_options' => array('label' => 'Confirmer'), 'type' => 'password', 'invalid_message' => 'Les champs de mot de passe doivent correspondre.')), 5 => 'enabled')), 'edit' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => array('property' => 'plainPassword', 'label' => 'Mot de passe', 'type' => 'repeated', 'type_options' => array('required' => false, 'first_options' => array('label' => 'Mot de passe'), 'second_options' => array('label' => 'Confirmer'), 'type' => 'password', 'invalid_message' => 'Les champs de mot de passe doivent correspondre.')), 5 => 'enabled'), 'form_options' => array('validation_groups' => array(0 => 'Profile'))), 'name' => 'Grossiste'), 'Gestionnaire' => array('class' => 'WebBundle\\Entity\\Utilisateurs', 'controller' => 'BackendBundle\\Controller\\Admin\\GestionnaireController', 'list' => array('fields' => array(0 => array('property' => 'username_canonical', 'label' => 'Nom d\'utilisateur'), 1 => 'email', 2 => array('property' => 'locked', 'label' => 'Est bloqué ?'), 3 => array('property' => 'last_login', 'label' => 'Date dernière connexion', 'format' => 'd/m/Y h:i', 'template' => '@EasyAdmin/default/field_datetime.html.twig')), 'title' => 'La liste des gestionnaires', 'actions' => array(0 => 'new', 1 => 'edit')), 'form' => array('fields' => array(0 => array('property' => 'username', 'label' => 'Nom d\'utilisateur'), 1 => array('property' => 'lastName', 'label' => 'Nom'), 2 => array('property' => 'firstName', 'label' => 'Prénom'), 3 => 'email', 4 => 'enabled')), 'name' => 'Gestionnaire'), 'CommandesGestionnaire' => array('class' => 'WebBundle\\Entity\\Commandes', 'controller' => 'BackendBundle\\Controller\\Admin\\AdminController', 'disabled_actions' => array(0 => 'delete', 1 => 'edit', 2 => 'new'), 'list' => array('fields' => array(0 => array('property' => 'reference', 'label' => 'Ref CMD', 'type' => 'string'), 1 => array('property' => 'commande', 'label' => 'Nb Article', 'template' => 'BackendBundle:admin\\commande:nbArticle.html.twig'), 2 => array('property' => 'utilisateur', 'label' => 'Client', 'template' => 'BackendBundle:admin\\commande:nomPrenomClient.html.twig'), 3 => array('property' => 'total', 'label' => 'Total Commande', 'template' => 'BackendBundle:admin\\commande:totaleCommande.html.twig'), 4 => array('property' => 'status', 'label' => 'Statut', 'template' => '@Backend/admin/commande/status.html.twig', 'label_colors' => array(0 => 'pending', 1 => 'primary', 2 => 'success', 3 => 'default', 4 => 'danger')), 5 => array('property' => 'grossiste', 'label' => 'Grossiste', 'template' => 'BackendBundle:admin\\commande:grossisteCommande.html.twig'), 6 => array('property' => 'dateclient', 'label' => 'Date.Liv.Client', 'template' => 'BackendBundle:admin\\commande:dateReservationClient.html.twig'), 7 => array('property' => 'delivery_date', 'label' => 'Date.Liv.Grossiste')), 'actions' => array(0 => array('name' => 'show', 'label' => 'voir', 'icon' => 'eye'), 1 => array('name' => 'affecter', 'label' => 'Affecter.Auto', 'icon' => 'pencil'))), 'name' => 'CommandesGestionnaire')), 'formats' => array('date' => 'Y-m-d', 'time' => 'H:i:s', 'datetime' => 'F j, Y H:i', 'dateinterval' => '%y Year(s) %m Month(s) %d Day(s)'), 'disabled_actions' => array(), 'translation_domain' => 'messages', 'list' => array('actions' => array(), 'max_results' => 15), 'search' => array(), 'edit' => array('actions' => array()), 'new' => array('actions' => array()), 'show' => array('actions' => array(), 'max_results' => 10)), 'easyadmin.listener.exception:showExceptionPageAction', $this->get('monolog.logger.request', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    public function getKnpPaginatorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['knp_paginator'] = new KnpComponentPagerPaginator_00000000558638f900000000270ffb928e39438d2e9766a43e958a5652d9de6f(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
        ...
        $instance = new \Knp\Component\Pager\Paginator($this->get('event_dispatcher'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy.admin'), $d, 'main', $g, $h, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '64dfee47a519f3.73203105', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'fos_user_security_login', false), NULL, $this->get('app.security.access_denied_handler'), $b, false), $i);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('64dfee47a519f3.73203105'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('64dfee47a519f3.73203105')), true);
...
class DoctrineORMEntityManager_00000000558622e900000000270ffb928e39438d2e9766a43e958a5652d9de6f extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder64dfee4892737724606682 = null;
    private $initializer64dfee489273f664524435 = null;
    private static $publicProperties64dfee489271e825216540 = array(
        
    );
    public function getConnection()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getConnection', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getMetadataFactory', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getExpressionBuilder', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'beginTransaction', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getCache', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getCache();
    }
    public function transactional($func)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'transactional', array('func' => $func), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->transactional($func);
    }
    public function commit()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'commit', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->commit();
    }
    public function rollback()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'rollback', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getClassMetadata', array('className' => $className), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'createQuery', array('dql' => $dql), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'createNamedQuery', array('name' => $name), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'createQueryBuilder', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'flush', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'clear', array('entityName' => $entityName), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->clear($entityName);
    }
    public function close()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'close', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->close();
    }
    public function persist($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'persist', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'remove', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'refresh', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'detach', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'merge', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getRepository', array('entityName' => $entityName), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'contains', array('entity' => $entity), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getEventManager', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getConfiguration', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'isOpen', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getUnitOfWork', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getProxyFactory', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'initializeObject', array('obj' => $obj), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'getFilters', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'isFiltersStateClean', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'hasFilters', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return $this->valueHolder64dfee4892737724606682->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer64dfee489273f664524435 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__get', array('name' => $name), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        if (isset(self::$publicProperties64dfee489271e825216540[$name])) {
            return $this->valueHolder64dfee4892737724606682->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee4892737724606682;
    ...
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee4892737724606682;
    ...
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__isset', array('name' => $name), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee4892737724606682;
    ...
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__unset', array('name' => $name), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee4892737724606682;
    ...
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__clone', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        $this->valueHolder64dfee4892737724606682 = clone $this->valueHolder64dfee4892737724606682;
    }
    public function __sleep()
    {
        $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, '__sleep', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
        return array('valueHolder64dfee4892737724606682');
    }
    ...
    {
        return $this->initializer64dfee489273f664524435;
    }
    public function initializeProxy()
    {
        return $this->initializer64dfee489273f664524435 && ($this->initializer64dfee489273f664524435->__invoke($valueHolder64dfee4892737724606682, $this, 'initializeProxy', array(), $this->initializer64dfee489273f664524435) || 1) && $this->valueHolder64dfee4892737724606682 = $valueHolder64dfee4892737724606682;
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder64dfee4892737724606682;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder64dfee4892737724606682;
    }
}

class KnpComponentPagerPaginator_00000000558638f900000000270ffb928e39438d2e9766a43e958a5652d9de6f extends \Knp\Component\Pager\Paginator implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder64dfee48a1a13616996103 = null;
    private $initializer64dfee48a1a1f032393856 = null;
    private static $publicProperties64dfee48a19f6549480083 = array(
        
    );
    public function setDefaultPaginatorOptions(array $options)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, 'setDefaultPaginatorOptions', array('options' => $options), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        return $this->valueHolder64dfee48a1a13616996103->setDefaultPaginatorOptions($options);
    }
    public function paginate($target, $page = 1, $limit = 10, array $options = array())
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        return $this->valueHolder64dfee48a1a13616996103->paginate($target, $page, $limit, $options);
    }
    public function subscribe(\Symfony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, 'subscribe', array('subscriber' => $subscriber), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        return $this->valueHolder64dfee48a1a13616996103->subscribe($subscriber);
    }
    public function connect($eventName, $listener, $priority = 0)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, 'connect', array('eventName' => $eventName, 'listener' => $listener, 'priority' => $priority), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        return $this->valueHolder64dfee48a1a13616996103->connect($eventName, $listener, $priority);
    }
    public function __construct($initializer)
    {
        $this->initializer64dfee48a1a1f032393856 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__get', array('name' => $name), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        if (isset(self::$publicProperties64dfee48a19f6549480083[$name])) {
            return $this->valueHolder64dfee48a1a13616996103->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee48a1a13616996103;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee48a1a13616996103;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__isset', array('name' => $name), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee48a1a13616996103;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__unset', array('name' => $name), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder64dfee48a1a13616996103;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__clone', array(), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        $this->valueHolder64dfee48a1a13616996103 = clone $this->valueHolder64dfee48a1a13616996103;
    }
    public function __sleep()
    {
        $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, '__sleep', array(), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
        return array('valueHolder64dfee48a1a13616996103');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer64dfee48a1a1f032393856;
    }
    public function initializeProxy()
    {
        return $this->initializer64dfee48a1a1f032393856 && ($this->initializer64dfee48a1a1f032393856->__invoke($valueHolder64dfee48a1a13616996103, $this, 'initializeProxy', array(), $this->initializer64dfee48a1a1f032393856) || 1) && $this->valueHolder64dfee48a1a13616996103 = $valueHolder64dfee48a1a13616996103;
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder64dfee48a1a13616996103;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder64dfee48a1a13616996103;
    }
}
