 ...
 */
class Size extends \WebBundle\Entity\Size implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebBundle\\Entity\\Size' . "\0" . 'id', '' . "\0" . 'WebBundle\\Entity\\Size' . "\0" . 'libelle', '' . "\0" . 'WebBundle\\Entity\\Size' . "\0" . 'produit', '' . "\0" . 'WebBundle\\Entity\\Size' . "\0" . 'couleur', '' . "\0" . 'WebBundle\\Entity\\Size' . "\0" . 'quantite'];
        }
