 ...
 */
class Commande_Produit extends \WebBundle\Entity\Commande_Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'id', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'commande', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'produit', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'sizes', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'quantite', '' . "\0" . 'WebBundle\\Entity\\Commande_Produit' . "\0" . 'prix'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Commande_Produit $proxy) {
    ...
    public function addSizes($size)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSizes', [$size]);

        return parent::addSizes($size);
    }
    ...
    public function removeSizes($size)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSizes', [$size]);

        return parent::removeSizes($size);
    }
     ...
     * {@inheritDoc}
     */
    public function setCommande(\WebBundle\Entity\Commandes $commande)
    {
     ...
     * {@inheritDoc}
     */
    public function setProduit(\WebBundle\Entity\Produits $produit)
    {
