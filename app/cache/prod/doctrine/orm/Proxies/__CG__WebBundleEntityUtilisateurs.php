 ...
 */
class Utilisateurs extends \WebBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'firstName', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'lastName', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'date_naissance', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'tel', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'telFacultatif', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'matriculeFiscale', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'pays', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'station', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'accept_pub', 'plainPassword', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'commandes', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'favoris', '' . "\0" . 'WebBundle\\Entity\\Utilisateurs' . "\0" . 'adresses', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addCommande(\WebBundle\Entity\Commandes $commandes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCommande', [$commandes]);
    ...
    public function removeCommande(\WebBundle\Entity\Commandes $commandes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCommande', [$commandes]);
    ...
    public function removeAdress(\WebBundle\Entity\UtilisateursAdresses $adresses)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAdress', [$adresses]);
    ...
    public function getTelFacultatif()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTelFacultatif', []);

        return parent::getTelFacultatif();
    }
    ...
    public function setTelFacultatif($telFacultatif)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTelFacultatif', [$telFacultatif]);

        return parent::setTelFacultatif($telFacultatif);
    }
    ...
    public function getAcceptPub()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAcceptPub', []);

        return parent::getAcceptPub();
    }
    ...
    public function setAcceptPub($accept_pub)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAcceptPub', [$accept_pub]);

        return parent::setAcceptPub($accept_pub);
    }
