 ...
 */
class Favoris extends \WebBundle\Entity\Favoris implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebBundle\\Entity\\Favoris' . "\0" . 'id', '' . "\0" . 'WebBundle\\Entity\\Favoris' . "\0" . 'utilisateur', '' . "\0" . 'WebBundle\\Entity\\Favoris' . "\0" . 'produit', '' . "\0" . 'WebBundle\\Entity\\Favoris' . "\0" . 'isActive'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Favoris $proxy) {
