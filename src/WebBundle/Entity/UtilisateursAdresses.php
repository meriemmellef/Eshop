 ...
 *
 * @ORM\Table("useradresses")
 * @ORM\Entity(repositoryClass="WebBundle\Repository\UtilisateursAdressesRepository")
 */
class UtilisateursAdresses
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Utilisateurs", inversedBy="adresses")
